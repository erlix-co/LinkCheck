...
/* SEO content (intro, points, FAQ) is now rendered statically in index.html
   so it's visible in raw HTML to crawlers. The previous `seoContent` object
   was removed together with its React-rendered <section className="seo-content">. */
...
export function App() {
  ...
  return (
    <main className="page" dir={language === "he" ? "rtl" : "ltr"} lang={language}>
      ...
      {/* SEO content (h1, intro, FAQ) is now rendered statically in index.html
          below #root, so it's visible to crawlers and not duplicated for users. */}
